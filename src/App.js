...
function App() {
  ...
  const movies = [ { title: 'The Shawshank Redemption', genre: 'Drama', year: 1994 }, { title: 'The Godfather', genre: 'Crime', year: 1972 },
     { title: 'The Dark Knight', genre: 'Action', year: 2008 }, { title: '12 Angry Men', genre: 'Drama', year: 1957 },
      { title: 'Schindlers List', genre: 'Drama', year: 1993 }, { title: 'The Lord of the Rings The Return of the King', genre: 'Fantasy', year: 2003 }, 
     ...
     { title: 'Jurassic Park', genre: 'Science Fiction', year: 1993 }, { title: 'Terminator 2: Judgment Day', genre: 'Science Fiction', year: 1991 }, 
     { title: 'The Lion King', genre: 'Animation', year: 1994 } ];

  return (
    <div className="App">
      <p>Top 15 Movies of All Time</p>
      <MovieList movieArray={movies} />
      {/* <GenreFilter genreArray={genres}/> */}
    </div>
  );
}
